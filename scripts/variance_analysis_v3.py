...
class VarianceAnalyzerV3:
    ...
    def generate_variance_report(self):
        ...
        report_dir = f"logs/variance_analysis_v3_{timestamp}"
        os.makedirs(report_dir, exist_ok=True)
        
        # レポート内容
        report_content = []
        report_content.append("=" * 80)
        report_content.append("データばらつき原因分析レポート v3")
        report_content.append("=" * 80)
    ...
    def generate_variance_plots(self, report_dir):
        ...
        fig.suptitle('データばらつき分析 v3', fontsize=16, fontweight='bold')
