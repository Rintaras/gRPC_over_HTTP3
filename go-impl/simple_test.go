...
func main() {
	fmt.Println("=== Simple gRPC Connection Test ===")
	...
	if err != nil {
		...
		fmt.Printf("✓ HTTP/2 response: %s (protocol: %s)\n", resp2.Message, resp2.Protocol)
	}
	...
	if err != nil {
		...
		fmt.Printf("✓ HTTP/3 response: %s (protocol: %s)\n", resp3.Message, resp3.Protocol)
	}
